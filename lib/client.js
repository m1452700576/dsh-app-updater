...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var zh = {
      ...
      confirmCancel: "取消",
      ignoreVersion: "忽略此版本",
      coreOutdatedTitle: "DSH 核心包有更新",
      coreUpdateHint: "桌面安装包可能未同步，请关注官方发布后再升级",
      viewOfficial: "查看官方更新",
      changelog: "更新日志",
      hideChangelog: "收起日志",
    };
    var en = {
      ...
      coreOutdatedTitle: "DSH core packages have updates",
      coreUpdateHint: "Desktop installer may not be synced yet; watch for an official release before upgrading",
      viewOfficial: "View official releases",
      changelog: "Changelog",
      ...
      if (open) {
        ...
        if (view.kind === "downloading") {
          ...
          body = [
            ...
            (d.coreOutdated && d.coreOutdated.length) ? h("div", { key: "core", style: styles.urlBox }, [
              h("p", { key: "ct", style: styles.warn }, "⚠ " + L.coreOutdatedTitle),
              h("ul", { key: "cu", style: { paddingLeft: 16, margin: "6px 0" } }, d.coreOutdated.map(function (u, i) { return h("li", { key: i }, u.label + ": " + (u.local || "?") + " → " + (u.target || "?")); })),
              h("p", { key: "ch", style: styles.muted }, L.coreUpdateHint),
              d.officialUrl ? h("div", { key: "co", style: styles.actions }, h("button", { style: styles.ghost, onClick: function () { window.open(d.officialUrl, "_blank"); } }, L.viewOfficial)) : null,
            ]) : null,
            ...
            urlCheckBox,
            ((d.outdated && d.downloadUrl) || (urlCheck && urlCheck.reachable && !urlCheck.privateHost))
              ? h("div", { key: "dl", style: styles.actions }, 
                  h("button", { style: styles.primary, onClick: startConfirm }, L.download),
                  (d.outdated && d.downloadUrl) ? h("button", { style: Object.assign({}, styles.ghost, { marginLeft: 8 }), onClick: function() { 
                    safeSetIgnored(d.latest);
                    set(function(s) { return Object.assign({}, s, { available: false }); });
                  } }, L.ignoreVersion) : null
                )
              : h("p", { key: "ok", style: styles.ok }, (d.outdated && !d.downloadUrl) ? L.coreOutdatedTitle : L.upToDate),
